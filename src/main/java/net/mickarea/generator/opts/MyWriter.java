...
public final class MyWriter {
	...
	public static final String writeFileHeader(String entityName) {
		...
		sb.append(lineSeperator);
		sb.append("This file is automatically generated."+lineSeperator);
		sb.append("This file \""+entityName+".java\" is part of project <\"just write what you want\"> , which is belong to Michael Pang (It's Me)."+lineSeperator);
